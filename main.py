#I have my information stored on a local file for security however you can change this
#DO NOT POST YOUR CODE WITH THIS INFORMATION, AS OTHERS CAN USE IT TO ACCESS YOUR EMAIL
File_object = open(r"C:/Users/erico/Documents/sensitive.txt","r")
email_sender =   File_object.readline().rstrip() # or something like = youremail@email.com
email_password = File_object.readline().rstrip() # or something like = gmail app password (dont forget to remove spaces)
email_receiver = File_object.readline().rstrip() # or something like = emailyoursendingto@email.com
